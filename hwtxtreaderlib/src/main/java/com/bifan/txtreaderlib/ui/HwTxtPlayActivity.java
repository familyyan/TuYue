...
public class HwTxtPlayActivity extends AppCompatActivity {
    ...
    //my custom
    protected TextView show_qq;
    protected TextView backHome;
    protected RelativeLayout qq_reader;
    ...
    protected void init() {
        ...
        //my custom
        show_qq = findViewById(R.id.show_qq);
        last_page = findViewById(R.id.last_page);
        next_page = findViewById(R.id.next_page);
        backHome = findViewById(R.id.activity_hwtxtplay_setting_back);

        qq_reader = findViewById(R.id.qq_reader);
        show_qq.setText(R.string.ad_qq);
        mTxtReaderView.setBackgroundColor(StyleTextColors[0]);
        mTopDecoration.setBackgroundColor(StyleTextColors[0]);
        mBottomDecoration.setBackgroundColor(StyleTextColors[0]);
        qqBg = TxtConfig.getQQBg(this);
        qq_reader.setBackgroundColor(qqBg);

        if (mChapterListPop != null) {
            mChapterListPop.setBackGroundColor(StyleTextColors[0]);
        }
        //上一页
        last_page.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mTxtReaderView.doPagePreDone();
            }
        });
        //下一页
...
//        mTxtReaderView.setTextSize(23);
    ...
    protected void onDestroy() {
        TxtConfig.saveQQReaderBg(this, qqBg);
        super.onDestroy();
        exist();
    }
