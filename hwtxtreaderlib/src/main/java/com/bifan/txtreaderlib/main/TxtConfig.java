...
public class TxtConfig {
    ...
    private static final String C_QQ_BG = "C_QQ_BG ";
    ...
    public static final int MIN_TEXT_SIZE = 20;//in px
    ...
    public static void saveQQReaderBg(Context context, int backgroundColor) {
        SharedPreferences share = getS(context);
        SharedPreferences.Editor editor = share.edit();
        editor.putInt(C_QQ_BG, backgroundColor);
        editor.commit();
    }

    public static int getQQBg(Context context) {
        SharedPreferences share = getS(context);
        return share.getInt(C_QQ_BG, 0);
    }
