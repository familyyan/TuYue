...
public class StatusBarUtil {
    ...
    //    public static int DEFAULT_COLOR = 0xff323232;
    public static int DEFAULT_COLOR = 0x00323232;
...
//        window.setStatusBarColor(Color.TRANSPARENT);
     ...
     * @param color
     */
    public static void buildStatuSpace(Context context, View view, int color) {
        ViewGroup.LayoutParams lp = view.getLayoutParams();
        lp.height = getStatusBarHeight(context);//增高
     ...
     * @param view
     */
    public static void buildStatuSpace(Context context, View view) {
        buildStatuSpace(context, view, DEFAULT_COLOR);
    }
    ...
    public static int mixtureColor(int color, @FloatRange(from = 0.0, to = 1.0) float alpha) {
        ...
        a = (color & 0x00ffffff) | (((int) (a * alpha)) << 24);
        return a;
    }
