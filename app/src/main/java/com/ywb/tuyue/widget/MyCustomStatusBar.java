...
public class MyCustomStatusBar extends LinearLayout {
    ...
    public MyCustomStatusBar(Context context) {
        this(context, null);
    }

    public MyCustomStatusBar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyCustomStatusBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        statusBarView = LayoutInflater.from(c).inflate(R.layout.status_bar, this);
